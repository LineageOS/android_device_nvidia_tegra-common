...
ifeq ("$(wildcard vendor/nvidia/$(TARGET_TEGRA_VERSION)/$(notdir $(LOCAL_PATH))/$(NVIDIA_SRC_FILES_32))","")
ifeq ("$(wildcard vendor/nvidia/$(TARGET_TEGRA_VERSION)/$(notdir $(LOCAL_PATH))/$(NVIDIA_SRC_FILES_64))","")
