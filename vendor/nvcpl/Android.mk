...
LOCAL_SRC_FILES_32         := $(COMMON_NVCPL_PATH)/lib/vendor.nvidia.hardware.cpl.interfacecb@1.0.so
LOCAL_SRC_FILES_64         := $(COMMON_NVCPL_PATH)/lib64/vendor.nvidia.hardware.cpl.interfacecb@1.0.so
LOCAL_MULTILIB             := both
...
LOCAL_SRC_FILES_32         := $(COMMON_NVCPL_PATH)/lib/vendor.nvidia.hardware.cpl.service@1.0.so
LOCAL_SRC_FILES_64         := $(COMMON_NVCPL_PATH)/lib64/vendor.nvidia.hardware.cpl.service@1.0.so
LOCAL_MULTILIB             := both
LOCAL_MODULE_SUFFIX        := .so
LOCAL_MODULE_CLASS         := SHARED_LIBRARIES
LOCAL_MODULE_TAGS          := optional
...
LOCAL_SRC_FILES_32         := $(COMMON_NVCPL_PATH)/lib/vendor.nvidia.hardware.cpl.tools@1.0.so
LOCAL_SRC_FILES_64         := $(COMMON_NVCPL_PATH)/lib64/vendor.nvidia.hardware.cpl.tools@1.0.so
LOCAL_MULTILIB             := both
LOCAL_MODULE_SUFFIX        := .so
LOCAL_MODULE_CLASS         := SHARED_LIBRARIES
LOCAL_MODULE_TAGS          := optional
