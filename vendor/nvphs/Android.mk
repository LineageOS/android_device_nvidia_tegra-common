...
COMMON_NVPHS_PATH := ../../../../../vendor/nvidia/common/nvphs

include $(CLEAR_VARS)
LOCAL_MODULE               := vendor.nvidia.hardware.phs@1.0
LOCAL_SRC_FILES_32         := $(COMMON_NVPHS_PATH)/lib/vendor.nvidia.hardware.phs@1.0.so
LOCAL_SRC_FILES_64         := $(COMMON_NVPHS_PATH)/lib64/vendor.nvidia.hardware.phs@1.0.so
LOCAL_MULTILIB             := both
