...
function fetch_bcm4356_patchfile() {
  ...
  wget 'https://github.com/winterheart/broadcom-bt-firmware/raw/ddb24edc5169d064af3f405d6307aa4661a2cc52/brcm/BCM4356A2-13d3-3488.hcd' -O ${LINEAGE_ROOT}/${OUTDIR}/common/external/bcm_firmware/bcm4356/BCM4356A2-13d3-3488.hcd
}
...
function patch_nvpmodel() {
  ...
  LOCALTMPDIR=$(mktemp -d)
  pushd ${LOCALTMPDIR}
  ar x ${LINEAGE_ROOT}/${OUTDIR}/common/r35/nvpmodel/nvidia-l4t-nvpmodel_arm64.deb data.tar.zst
  ...
  ${LINEAGE_ROOT}/prebuilts/extract-tools/linux-x86/bin/patchelf-0_9 --set-interpreter /vendor/bin/l4t/ld-linux-aarch64.so.1 ${LINEAGE_ROOT}/${OUTDIR}/common/r35/nvpmodel/bin64/nvpmodel
...
function fetch_bmps() {
  ...
  wget ${NV_TEGRA_URL}/nvidia1080.bmp -O ${LINEAGE_ROOT}/${OUTDIR}/common/rel-30/BMP/nvidia1080.bmp
  wget ${NV_TEGRA_URL}/verity_orange_continue_1080.bmp -O ${LINEAGE_ROOT}/${OUTDIR}/common/rel-30/BMP/verity_orange_continue_1080.bmp
  wget ${NV_TEGRA_URL}/verity_orange_pause_1080.bmp -O ${LINEAGE_ROOT}/${OUTDIR}/common/rel-30/BMP/verity_orange_pause_1080.bmp
  wget ${NV_TEGRA_URL}/verity_red_continue_1080.bmp -O ${LINEAGE_ROOT}/${OUTDIR}/common/rel-30/BMP/verity_red_continue_1080.bmp
  wget ${NV_TEGRA_URL}/verity_red_pause_1080.bmp -O ${LINEAGE_ROOT}/${OUTDIR}/common/rel-30/BMP/verity_red_pause_1080.bmp
  wget ${NV_TEGRA_URL}/verity_yellow_continue_1080.bmp -O ${LINEAGE_ROOT}/${OUTDIR}/common/rel-30/BMP/verity_yellow_continue_1080.bmp
  wget ${NV_TEGRA_URL}/verity_yellow_pause_1080.bmp -O ${LINEAGE_ROOT}/${OUTDIR}/common/rel-30/BMP/verity_yellow_pause_1080.bmp
}
