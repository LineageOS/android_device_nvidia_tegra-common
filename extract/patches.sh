...
function patch_nvcontrol() {
  ...
  ${PATCHELF} --remove-needed "libjpeg.so" ${LINEAGE_ROOT}/${OUTDIR}/common/rel-shield-r/nvcpl/lib64/libnvcontrol_jni.so
  ${PATCHELF} --remove-needed "libjpeg.so" ${LINEAGE_ROOT}/${OUTDIR}/common/rel-shield-r/nvcpl/lib/libnvcontrol_jni.so
