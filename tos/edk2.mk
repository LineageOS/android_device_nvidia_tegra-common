...
GCC_HOST_PATH      := $(BUILD_TOP)/prebuilts/gcc/$(HOST_PREBUILT_TAG)/host/links/bin
...
ifeq ($(EDK2_TOOLCHAIN),GCC5)
TOOLCHAIN_VARS := GCC_HOST_BIN=$(abspath $(dir $(KERNEL_MAKE_CMD)))/ GCC5_$(EDK2_ARCH)_PREFIX=$(KERNEL_TOOLCHAIN)/$(KERNEL_TOOLCHAIN_PREFIX) PATH=$(GCC_HOST_PATH):$$PATH
else ifeq ($(EDK2_TOOLCHAIN),CLANG38)
TOOLCHAIN_VARS := CLANG_HOST_BIN=$(abspath $(dir $(KERNEL_MAKE_CMD)))/ CXX=llvm CLANG_BIN=$(TARGET_KERNEL_CLANG_PATH)/bin/ CLANG38_BIN=$(TARGET_KERNEL_CLANG_PATH)/bin/ EXTRA_LDFLAGS="-fuse-ld=lld" CLANG38_$(EDK2_ARCH)_PREFIX=$(TARGET_KERNEL_CLANG_PATH)/bin/llvm-
endif
