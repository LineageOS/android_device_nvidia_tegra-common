...
void tegra_init::set_properties()
{
    ...
    property_override("ro.product.vendor.name",   chosen_device->name.c_str());
    property_override("ro.product.vendor.device", chosen_device->device.c_str());
    property_override("ro.product.vendor.model",  chosen_device->model.c_str());
}
