...
EDK2_TOOLCHAIN     := GCC
EDK2_ARCH          := AARCH64
EDK2_TEGRA_ARCH    := $(shell tegra_ver="$(TARGET_TEGRA_VERSION)" && echo $${tegra_ver:0:3})x
...
$(1): $(DTC_HOST)
	...
	@export PYTHON_COMMAND=$(BUILD_TOOLS_PATH)/python3 && \
		...
		PYTHONPATH=$$$$PYTHONPATH:$(TIANOCORE_PATH)/edk2-nvidia-lineage/Silicon/NVIDIA/scripts/Kconfiglib \
			...
			$(abspath $(dir $1))/edk2-nvidia/Platform/NVIDIA/Tegra/DefConfigs/$(EDK2_TEGRA_ARCH)_android.defconfig && \
		...
		$(abspath $(dir $1))/edk2/BaseTools/BinWrappers/PosixLike/build -q -a $(EDK2_ARCH) -t $(EDK2_TOOLCHAIN) \
			...
			-DBUILD_GUID="$(shell grep PLATFORM_GUID $(TIANOCORE_PATH)/edk2-nvidia/Platform/NVIDIA/Tegra/DefConfigs/$(EDK2_TEGRA_ARCH)_android.defconfig |cut -d\" -f 2)" \
